/*
 * @Author: star-cs
 * @Date: 2025-07-23 16:45:24
 * @LastEditTime: 2025-07-23 16:46:33
 * @FilePath: /TMMS-SERVER/tmms/network/base/msgbuffer.h
 * @Description:
 */
...
public:
     ...
     * @param b
     */
    void AddInFrontInt8(const uint8_t b) { AddInFront(static_cast<const char*>((void*)&b), 1); }
...
{
template<>
inline void swap(tmms::net::MsgBuffer& one, tmms::net::MsgBuffer& two) noexcept
{
    one.Swap(two);
}
} // namespace std