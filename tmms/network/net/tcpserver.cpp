 ...
 * @LastEditTime: 2025-07-24 14:15:21
 * @FilePath: /TMMS-SERVER/tmms/network/net/tcpserver.cpp
 * @Description:  learn
 */
...
{
    CORE_DEBUG("new connection fd:{}, host:{}", fd, addr.ToIpPort());
...
{
    CORE_DEBUG("host:{} closed.", con->PeerAddr().ToIpPort());
